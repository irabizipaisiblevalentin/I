"""Umurongo (Row) layout for horizontal arrangement of children."""
...
class Umurongo:
    """Umurongo (Row) layout - arranges children horizontally.

    Args:
        children: Initial list of child elements.
        spacing: Horizontal space between children.
        padding: Padding around the layout edge.
        alignment: Vertical alignment of children (main axis).
        cross_alignment: Horizontal alignment (cross axis).
        width: Fixed width of the row.
        height: Fixed height of the row.
        scrollable: Whether the row supports scrolling.
    ...
    def children(self) -> List[Any]:
        """List of child elements in the row."""
    ...
    def alignment(self) -> Alignment:
        """Vertical alignment of children (main axis)."""
    ...
    def scrollable(self) -> bool:
        """Whether the row supports scrolling."""
